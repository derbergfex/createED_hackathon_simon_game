...
int b = A4;  //For displaying segment "b"
int c = A3;  //For displaying segment "c"
int d = A2;  //For displaying segment "d"
int e = A1;  //For displaying segment "e"
int f = A0;  //For displaying segment "f"
